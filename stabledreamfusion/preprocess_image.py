...
class DPT():
    def __init__(self, task='depth', device='cuda'):
        ...
        if task == 'depth':
            path = '/home/ubuntu/Projects/perfect365/stabledreamfusion/pretrained/omnidata/omnidata_dpt_depth_v2.ckpt'
            ...
            path = '/home/ubuntu/Projects/perfect365/stabledreamfusion/pretrained/omnidata/omnidata_dpt_normal_v2.ckpt'
